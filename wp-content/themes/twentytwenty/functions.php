...
function mytheme_enqueue_styles()
{
	...
	// 3/10 chỉnh sửa expect lengh
	/**
	 * Chỉnh sửa độ dài của đoạn trích dẫn (Excerpt length).
	 * Mặc định là 55 từ. Hàm này sẽ giới hạn lại còn 20 từ.
	 */
	function custom_excerpt_length($length)
	{
		// Thay đổi 20 thành số từ bạn muốn.
		return 50;
	}
	add_filter('excerpt_length', 'custom_excerpt_length', 999);

	/**
	 * Thay đổi dấu ba chấm [...] ở cuối đoạn trích dẫn.
	 * Mặc định là [...]
	 */
	function custom_excerpt_more($more)
	{
		// Bạn có thể thay đổi '...' thành bất cứ thứ gì bạn muốn (ví dụ: ' [Xem thêm]')
		return '[Xem thêm]';
	}
